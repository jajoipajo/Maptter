...
def build_toponyms() -> tuple[dict[str, Toponym], dict[str, str]]:
    base = {
        ...
        "tigris": Toponym(
            ...
            43.9,
            line_coords=[
                (37.28, 42.05),  # source in Taurus mountains (Turkey)
                (37.02, 41.73),
                (36.79, 41.50),
                (36.34, 41.22),
                (35.95, 40.99),
                (35.52, 40.84),  # Mosul area
                (35.11, 41.03),
                (34.74, 41.49),  # Tikrit area
                (33.31, 44.38),  # Baghdad area
                (32.49, 44.42),  # Kut area
                (31.98, 47.44),  # Amarah area
                (31.00, 47.44),  # confluence toward Shatt al-Arab (near Al Qurnah)
            ],
        ),
